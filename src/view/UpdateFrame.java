...
import Design.RoundedButton;
 ...
 //정보 수정 UPDATE
public class UpdateFrame extends JPanel implements MouseListener{
	...
	public void mouseClicked(MouseEvent e) {
			...
			try {
				switch(b.getText()) {
					case "완료":
						result=obj.studentUpdate(tf1.getText(),tf2.getText(),Integer.parseInt(tf3.getText()) ,tf4.getText(),tf5.getText(),tf6.getText(),Integer.parseInt(tf7.getText()),Integer.parseInt(tf8.getText()));
						if(result<1)
							JOptionPane.showMessageDialog(null,"ID가 유효하지 않습니다.");
						else
							JOptionPane.showMessageDialog(null,tf2.getText()+"학생의 수정이 완료되었습니다.");
						break;
					case "취소":
						JOptionPane.showMessageDialog(null,"학생 정보 수정을 종료합니다.");
						new MainFrame();
						f.dispose();
						break;
				}
